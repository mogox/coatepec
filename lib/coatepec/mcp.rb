...
module Coatepec
  ...
  # `rails_spec_flaky_check`, `rails_routes`, `rails_model`, and `rails_job`
  # tools into an `::MCP::Server` instance backed by the given project's
  # worker manager.
  module MCP
    def self.build_server(project:, worker_manager:)
      ::MCP::Server.new(
        ...
        tools: [SpecRunTool, RuntimeStatusTool, RuntimeRestartTool, FlakyCheckTool, RoutesTool, ModelTool, JobTool],
